...
export default function Areas({ areas }) {
  ...
  return (
    <section id="areas" ref={ref} className="fade-in-section py-20 px-6 max-w-5xl mx-auto">
      <p className="font-mono text-neon text-xs mb-2 tracking-widest uppercase text-glow">// o que eu faço</p>
      <h2 className="font-mono text-3xl font-bold text-white mb-3">Minhas funções principais</h2>
      <p className="text-textprimary/70 text-sm mb-10 max-w-2xl">
        Meu eixo é defesa: SOC, Blue Team, IAM e vulnerabilidades. Os cards marcados como{' '}
        <span className="text-neon/80 font-mono">ofensivo</span> são estudo de laboratório, rumo ao Purple Team.
      </p>
